...
('Нейросети. В каких странах и в каких сферах они уже используются?'),
('Зарождение искусственного интеллекта'),
('Архитектура операционных систем для персональных компьютеров.'),
('Создание приложений для систем архитектуры Windows NT'),
('Разработка собственного дистрибутива Linux');
